...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-[#eaf7f0] border-b border-[#b8e0ca]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center justify-center space-x-3 lg:space-x-6 xl:space-x-8 absolute left-1/2 -translate-x-1/2">
            <Link
              href="/"
              className="text-[#1a5c38] hover:text-[#29bc89] text-xs xl:text-sm font-bold transition-colors whitespace-nowrap"
            >
              Home
            </Link>
            <Link
          ...
          <div className="flex items-center space-x-4 sm:space-x-5">
            <button
              ...
              className="text-[#1a5c38] hover:text-[#29bc89] transition-colors"
            >
              <Search className="h-5 w-5 sm:h-5 sm:w-5" strokeWidth={2} />
            </button>
            <Link
              href="/wishlist"
              className="text-[#1a5c38] hover:text-[#29bc89] transition-colors relative"
            >
            ...
            {isAuthenticated ? (
              <div className="relative hidden sm:block" ref={profileRef}>
                <button
                  ...
                  className="flex items-center gap-2 md:px-3 lg:px-4 py-2 text-sm font-bold text-[#1a5c38] bg-white/70 hover:bg-white rounded-full transition-colors border border-[#b8e0ca]"
                >
                  {user?.image ? (
                    <img
                      src={user.image}
              ...
              <Link
                href="/login"
                className="hidden sm:inline-flex items-center justify-center px-5 py-2 border border-[#29bc89] rounded-lg text-sm font-bold text-[#1a5c38] bg-white/70 hover:bg-white transition-colors"
              >
                Sign In
              </Link>
            )}
            ...
            <div className="flex md:hidden">
              <button
                ...
                className="text-[#1a5c38] hover:text-[#29bc89]"
              >
      ...
      {isSearchOpen && (
        <div className="absolute top-full left-0 w-full bg-[#eaf7f0] border-b border-[#b8e0ca] p-4 shadow-lg animate-in slide-in-from-top-2 duration-200 z-40">
