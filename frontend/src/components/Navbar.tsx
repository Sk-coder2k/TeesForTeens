      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center justify-center space-x-8 absolute left-1/2 -translate-x-1/2">
            <Link href="/" className="text-gray-500 hover:text-gray-900 text-sm font-bold transition-colors">Home</Link>
            <Link href="/shop" className="text-gray-500 hover:text-gray-900 text-sm font-bold transition-colors">Shop</Link>
            <Link href="/shop?category=Oversized" className="text-gray-500 hover:text-gray-900 text-sm font-bold transition-colors">Oversized</Link>
            <Link href="/shop?category=Streetwear" className="text-gray-500 hover:text-gray-900 text-sm font-bold transition-colors">Streetwear</Link>
            <Link href="/shop?category=Couple" className="text-gray-500 hover:text-gray-900 text-sm font-bold transition-colors">Couple Tees</Link>
          </div>
