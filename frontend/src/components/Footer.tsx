...
const INSTAGRAM_URL =
  "https://www.instagram.com/tees.forteens?igsh=YXlybzBpMm5nNWQ1&utm_source=qr";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold tracking-tighter text-mint-800">
              TeesforTeens.
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link
                  href="/faq"
                  className="hover:text-[#29bc89] transition-colors"
                >
                  FAQ
                </Link>
              </li>
        ...
        <div className="mt-16 pt-8 border-t border-mint-200 text-center text-sm text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} TeesforTeens. All rights reserved.
          </p>
