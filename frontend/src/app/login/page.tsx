...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-mint-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[url('https://images.unsplash.com/photo-1523381210434-271e8be1f52b?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center">
      ...
      <div className="relative sm:mx-auto sm:w-full sm:max-w-md z-10">
        ...
        <div className="bg-white/90 backdrop-blur-md py-10 px-6 shadow-2xl rounded-3xl sm:px-10 border border-white/50">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="font-medium text-sm text-mint-600 hover:text-mint-500">
                  Forgot password?
                </a>
              </div>
              <div className="mt-1">
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <Link href="/register" className="font-bold text-mint-600 hover:text-mint-500 transition-colors">
              Create one now
            </Link>
          </div>
        </div>
