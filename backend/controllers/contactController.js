        ...
        await sendViaResend({
          ...
          html: `
            <div style="font-family:sans-serif;max-width:500px;margin:auto;padding:24px;border:1px solid #e5e7eb;border-radius:12px">
              <h2 style="color:#29bc89;margin-top:0">New Newsletter Subscriber 🎉</h2>
              <p><strong>${email}</strong> just subscribed to the TeesforTeens newsletter.</p>
              <p style="color:#6b7280;font-size:13px;">Total subscribers are growing!</p>
            </div>
          `,
        });
      } catch (e) {
